...
ActiveRecord::Schema.define(version: 20191015135622) do
  ...
  create_table "vw_lavaggi", id: false, force: :cascade, options: "ENGINE=MyISAM DEFAULT CHARSET=utf8" do |t|
    t.integer "starting_time",           limit: 1, null: false
    t.integer "ending_time",             limit: 1, null: false
    t.integer "carwash_special_code_id", limit: 1, null: false
    t.integer "nominativo",              limit: 1, null: false
    t.integer "targa",                   limit: 1, null: false
  end

  create_table "vw_leaves_calendar", id: false, force: :cascade, options: "ENGINE=MyISAM DEFAULT CHARSET=utf8" do |t|
    t.integer "categ",       limit: 1, null: false
    t.integer "Nome",        limit: 1, null: false
    t.integer "description", limit: 1, null: false
    t.integer "code",        limit: 1, null: false
    t.integer "color_code",  limit: 1, null: false
    t.integer "leave_from",  limit: 1, null: false
  ...
  add_foreign_key "vehicle_check_sessions", "users", column: "operator_id"
