    ...
    begin
      ...
      if @error.nil?
        if v.nil?
          ...
          v.update(vehicle_type: data[:vehicle_type], property: data[:property], model: data[:model], registration_model: data[:registration_model], dismissed: data[:dismissed], vehicle_typology: data[:vehicle_typology], mileage: data[:mileage] > v.milage ? data[:mileage].to_i : v.mileage, registration_date: data[:registration_date], vehicle_category: data[:vehicle_category], carwash_code: data[:carwash_code]) if update
    ...
    begin
      if @error.nil?
        ...
        if v.nil?
          ...
          v.update(vehicle_type: vehicle_type, property: property, model: model, registration_model: r['registration_model'], dismissed: dismissed, vehicle_typology: vehicle_typology, mileage: mileage > v.milage ? mileage : v.mileage, registration_date: registration_date, vehicle_category: vehicle_category, carwash_code: carwash_code) if update
    ...
    begin
      if @error.nil?
        if v.nil? #Vehicle does not exist
          ...
          v.update(vehicle_type: vehicle_type, property: property, model: model, registration_model: r['registration_model'], serie: serie, dismissed: dismissed, vehicle_typology: vehicle_typology, mileage: mileage > v.milage ? mileage : v.mileage, registration_date: registration_date, vehicle_category: vehicle_category, carwash_code: carwash_code) if update
